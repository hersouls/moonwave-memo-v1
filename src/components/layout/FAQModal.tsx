...
const FAQ_DATA: FAQCategory[] = [
  {
    ...
    items: [
      {
        q: '메모를 어떻게 작성하나요?',
        a: '우측 하단의 + 버튼을 누르거나 Alt+N 단축키로 새 메모를 작성할 수 있습니다. 명령 팔레트(Ctrl+K)에서 "새 메모"를 선택해도 됩니다.',
      },
      {
      ...
      {
        q: '주요 단축키를 알려주세요.',
        a: 'Ctrl+B(굵게), Ctrl+I(기울임), Ctrl+Shift+C(코드 블록), Ctrl+K(명령 팔레트), Alt+N(새 메모) 등을 지원합니다. 아무 곳에서나 Ctrl+/를 누르면 전체 단축키 가이드 창을 띄울 수 있습니다.',
      },
    ],
  },
  {
