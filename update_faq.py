...
filePath = 'd:/Moonwave_Web/Memo_v1.0/src/components/layout/FAQModal.tsx'
with open(filePath, 'r', encoding='utf-8') as f:
    content = f.read()

pattern = re.compile(r'const FAQ_DATA: FAQCategory\[\] = \[.*?\]\n\nexport', re.DOTALL)

new_faq_data = """const FAQ_DATA: FAQCategory[] = [
  {
    title: '메모 작성 & 편집 📝',
    items: [
      {
...
new_content = pattern.sub(new_faq_data, content)

with open(filePath, 'w', encoding='utf-8') as f:
    f.write(new_content)

print("FAQ_DATA has been updated recursively.")
